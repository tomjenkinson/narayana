...
#  [ $? = 0 ] || fatal "git rebase failed"
  ...
  ./build.sh clean install -DskipTests -Dts.smoke=false $IPV6_OPTS -Drelease=true -Dversion.org.jboss.jboss-transaction-spi=7.1.0.SP2 -Dversion.org.jboss.jbossts.jbossjts=4.17.42.Final $AS_XARGS
