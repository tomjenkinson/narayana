...
#  [ $? = 0 ] || fatal "git rebase failed"
  ...
  (cd .. && ./build.sh -f jboss-as/pom.xml clean install -DskipTests -Dts.smoke=false $IPV6_OPTS -Drelease=true -Dversion.org.jboss.jboss-transaction-spi=7.1.0.SP2 -Dversion.org.jboss.jbossts.jbossjts=4.17.42.Final  -Dversion.org.jboss.jbossts.jbossjts-integration=4.17.43.Final -Dversion.org.jboss.jbossts.jbossxts=4.17.43.Final $AS_XARGS)
...
function xts_as_tests {
  ...
  (cd ../ && ./build.sh -f ./jboss-as/testsuite/integration/xts/pom.xml -Pxts.integration.tests.profile -Dversion.org.jboss.jboss-transaction-spi=7.1.0.SP2 -Dversion.org.jboss.jbossts.jbossjts=4.17.43.Final -Dversion.org.jboss.jbossts.jbossjts-integration=4.17.43.Final -Dversion.org.jboss.jbossts.jbossxts=4.17.43.Final "$@" test $AS_XARGS)
